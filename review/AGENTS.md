...
- Treat files in `review/` as the primary source for reviewer feedback when drafting replies or
  planning fixes.
...
- For findings that only need a reply, explain the reason using requirements, ADRs, design
  documents, or current code behavior.
