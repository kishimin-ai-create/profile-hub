...
export default {
  meta: {
    type: "suggestion",
    docs: {
      description: "Require string literal unions to be derived from const definitions.",
    },
    schema: [],
  ...
  create(context) {
    return {
      TSTypeAliasDeclaration(node) {
        ...
        if (typeAnnotation.type !== "TSUnionType" || !typeAnnotation.types.every(isStringLiteral)) {
          return;
        }
